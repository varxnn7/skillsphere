...
import { Briefcase, Eye, Users, AlertCircle, PlusCircle, LayoutGrid, List } from 'lucide-react';
              ...
              >
                ...
                <div className="border-t border-dark-border/60 pt-4 mt-5 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="flex items-center gap-3 text-[11px] font-bold text-[#64748B] mr-2">
                  ...
                  {filteredGigs.map((gig) => (
                    <tr key={gig._id} className="hover:bg-white/5 transition-colors">
                      ...
                      <td className="p-4 text-right">
                        <RouterLink
                          to={`/client/gigs/${gig._id}/proposals`}
                          className="inline-block px-3 py-1.5 bg-brand-indigo/10 border border-brand-indigo/25 hover:bg-brand-indigo hover:text-white rounded-lg text-[10px] font-bold text-brand-indigo transition-all cursor-pointer"
                        >
                          View Bids
                        </RouterLink>
                      </td>

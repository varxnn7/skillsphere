...
const FreelancerCard = ({ profile }) => {
  ...
  return (
    <div className="bg-white border border-surface-border rounded-2xl p-6 hover:border-[rgba(255,255,255,0.06)] hover:shadow-2xl transition-all duration-300 relative group flex flex-col justify-between">
      <div>
        ...
        <div className="flex justify-between items-start gap-4 mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-500 text-xs font-semibold">{profile.title || 'Freelancer Partner'}</p>
            </div>
          </div>
        ...
        {profile.skills?.length > 0 && (
          <div className="flex flex-wrap gap-1.5 mb-6">
            ...
            {profile.skills.length > 4 && (
              <span className="text-[10px] font-bold px-2 py-1 text-slate-500">+{profile.skills.length - 4} more</span>
            )}
          </div>
        )}
      </div>
      ...
      <div className="border-t border-surface-border/60 pt-4 flex items-center justify-between">
        <div>
          <span className="block text-[9px] font-bold text-slate-500 uppercase tracking-wider mb-0.5">Hourly Rate</span>
        ...
        <a
          ...
          className="inline-flex items-center gap-1.5 bg-gradient-orange text-slate-900 px-4 py-2 rounded-xl font-bold hover-glow-orange text-xs cursor-pointer"
        >
